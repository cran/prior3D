...
vignette: >
  ...
  %\VignetteIndexEntry{Introduction to prior3D}
...
```{r Figure2, eval=TRUE, echo=FALSE, out.width = '50%', fig.align = "center"}
...
```{r Figure4, eval=TRUE, echo=FALSE, out.width = '60%', fig.align = "center"}
...
```{r Figure5, eval=TRUE, echo=FALSE, out.width = '75%', fig.align = "center"}
...
```{r Figure6, eval=TRUE, echo=FALSE, out.width = '75%', fig.align = "center"}
...
```{r Figure7, eval=TRUE, out.width = '75%', fig.align = "center"}
knitr::include_graphics("sa.jpg")
```
<p class="caption" align="center">
...
```{r Figure8, eval=TRUE, echo=FALSE, out.width = '75%', fig.align = "center"}
knitr::include_graphics("sku.jpg")
```
<p class="caption" align="center">
...
##   Input data are float numbers. Converting data to integer matrices.
```
```{r Figure9, eval=TRUE, echo=FALSE, out.width = '75%', fig.align = "center"}
knitr::include_graphics("rao.jpg")
```
<p class="caption" align="center">
